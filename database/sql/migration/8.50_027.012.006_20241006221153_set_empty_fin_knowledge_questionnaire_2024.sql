UPDATE PTY.PARTY 
SET BODY = JSON_MODIFY(JSON_MODIFY(BODY, '$.finKnowledgeQuestionnaire2024', JSON_QUERY('{}')), '$.finKnowledgeQuestionnaire2024.questionnaire', 
	JSON_QUERY(N'[
			{
				"itemNumber": 1,
...
AND (JSON_QUERY(BODY, '$.finKnowledgeQuestionnaire2024.questionnaire') IS NULL OR JSON_QUERY(BODY, '$.finKnowledgeQuestionnaire2024.questionnaire') = '[]')

...
AND (
qs.PRODUCT_CODE IN ('EBMBFKO', 'EBMBFKO', 'EBMZENIT', 'EBMAKCEPT', 'EBMOAS', 'EBMAKBARS', 'EBMGBFKO', 'EBMPYBFKO',
'EBMIBFKO', 'EBMPFBFKO', 'EBMGMINBANK', 'EBMOAS2', 'EBMG', 'EBMGP', 'EBMGSMP', 'EBMGREINVEST', 'EBMGZENIT',
'EBMOPTIMAOAS2', 'EBMGVTB', 'EBMGVVTB', 'EBMGBESTVTB', 'ECATFPVTB', 'ECATFVVTB', 'EBMGRETVTB', 'EBMMGREINVEST',
'EBMGLIFEINVEST', 'EBMGPB', 'EBMGN', 'EBMGNRETVTB', 'EBMGNVTB', 'ECATFZENIT', 'EBMGNT', 'ECATFUBRR')
OR ps.PRODUCT_CODE IN ('EBMBFKO', 'EBMBFKO', 'EBMZENIT', 'EBMAKCEPT', 'EBMOAS', 'EBMAKBARS', 'EBMGBFKO', 'EBMPYBFKO',
'EBMIBFKO', 'EBMPFBFKO', 'EBMGMINBANK', 'EBMOAS2', 'EBMG', 'EBMGP', 'EBMGSMP', 'EBMGREINVEST', 'EBMGZENIT',
'EBMOPTIMAOAS2', 'EBMGVTB', 'EBMGVVTB', 'EBMGBESTVTB', 'ECATFPVTB', 'ECATFVVTB', 'EBMGRETVTB', 'EBMMGREINVEST',
'EBMGLIFEINVEST', 'EBMGPB', 'EBMGN', 'EBMGNRETVTB', 'EBMGNVTB', 'ECATFZENIT', 'EBMGNT', 'ECATFUBRR')
)
...
SELECT cpctu.CONTRACT_NUMBER, cpctu.PRODUCT_CODE, cpctu.ISSUE_DATE
FROM #CONTRACT_PRODUCT_CONF_TO_UPDATE cpctu

OPEN cur
FETCH NEXT FROM cur INTO @contractNumber, @productCode, @issueDate
WHILE @@fetch_status = 0

BEGIN

	SET @dontNeedUpdate = (
			SELECT CASE WHEN JSON_QUERY(c.body, '$.productConfiguration') IS NOT NULL AND JSON_QUERY(c.common_body, '$.attributes.productConfigurationData') IS NOT NULL THEN 0 ELSE 1 END PRODUCT_CONF_EXIST FROM #CONTRACT_PRODUCT_CONF_TO_UPDATE c
			WHERE c.contract_number = @contractNumber)

	IF (@dontNeedUpdate = 0)

	BEGIN
		INSERT INTO PAS_IMPL.CONTRACT_BODY_PRODUCT_CONF_UPDATE_INFO (CONTRACT_NUMBER, PRODUCT_CODE, ISSUE_DATE, IS_UPDATED, INFO, DATE)
			SELECT
				@contractNumber,
				@productCode,
				@issueDate,

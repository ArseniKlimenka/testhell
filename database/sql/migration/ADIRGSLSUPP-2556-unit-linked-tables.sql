...
BEGIN
	...
	VALUES
		(NEWID(), @productVersionId, @productMarketType, @status, @creationDate, @approvalDate, @guaranteeFundId, @guaranteeId, @guaranteeFundShare, @insuranceShare, @budgetRuleId, @motivation, @totalAcquisShare, @riskFundGroupId, @riskFundShare, @skmargin, @optionsId, @historicalProfitAbilityId, @operation)
...
VALUES
    --demo
    ('4A1A3B05-74C2-43DB-9971-A18FBD6F4AA1', N'Акции', 2, 100, N'Нет', N'Да','02086FF4-A4FA-4866-A4D3-E04E9D2A8682', 'C0EEEBAA-0C20-42BA-B9F8-A3D48C1D5771', N'Нет'),
    --preEquity
    ('BEA3A5BB-959A-45CE-B75A-799ADC5A6D41', N'Акции', NULL, 100, N'Нет', N'Да', '89C3D117-9C37-472B-B611-78C34437A9FD', '321ED43B-B1A1-4979-BF40-256BD54C9D2A', N'Нет')
...
VALUES
    ...
    ('24B253B4-8C44-4DF2-97EB-62A83169FD49', '75F4B548-EF8A-4313-A2DF-ED4B9C363E27', N'Акции - Яндекс 2', '0DA66E61-A391-4350-9904-1A1258520EFA'),
    --preEquity
...
INSERT INTO PAS_IMPL.UL_PRODUCT_VERSION
    (PRODUCT_VERSION_ID, PRODUCT_MARKET_TYPE, STATUS, CREATION_DATE, APPROVAL_DATE, GUARANTEE_FUND_ID, GUARANTEE_ID, GUARANTEE_FUND_SHARE, INSURANCE_SHARE, MOTIVATION, TOTAL_ACQUIS_SHARE, RISK_FUND_GROUP_ID, RISK_FUND_SHARE, SKMARGIN, OPTIONS_ID, HISTORICAL_PROFITABILITY_ID)
VALUES
    --demo
    ('7127997E-A88C-4F29-8A88-ECB2A9AC3B15', N'Базис Инвест', N'Черновик', '2023-03-28', NULL, '93C69538-72C9-4627-90F3-52FE4C09BEC5', 'D3F715FE-14DB-4783-AE47-2A8C4540FA92', 0.8537, 0, 0, 0, 'D586E66D-CBC5-4321-953D-CD49DE2D05B9', 0.1463, 0, N'Продавай ежегодно ПИП РФ на сумму РФ первоначальный/срок', '632FC4F5-A0F9-409C-A4F9-4C500395F150'),
    --preEquity
    ('F11ACCCA-35C0-45E1-B10A-24475D3DE6CE', N'ИСЖ 2.0', N'Черновик', '2024-09-13', NULL, NULL, NULL, NULL, 1.87, 0.50, 4.78, '561F988A-AAFB-41AB-BC9A-9F97857AE5F8', 90, 2, N'Списание Mf ежеквартально по мере наличия д/с', '8A3D92BF-B949-4552-A8B8-0642B7B8AB79')

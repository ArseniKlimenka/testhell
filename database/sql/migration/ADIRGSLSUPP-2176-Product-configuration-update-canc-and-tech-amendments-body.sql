...
FROM PAS.CONTRACT canc
LEFT JOIN PAS_IMPL.CONTRACT_BODY_PRODUCT_CONF_UPDATE_INFO cbui ON cbui.CONTRACT_NUMBER = canc.CONTRACT_NUMBER
LEFT JOIN CFX.PUBLISHED_ARTIFACT pa ON pa.PUBLISHED_ARTIFACT_ID = canc.PUBLISHED_ARTIFACT_ID
...
AND (pa.CODE_NAME LIKE N'%Cancellation' OR pa.CODE_NAME LIKE N'%TechnicalAmendment')
--AND canc.CONTRACT_NUMBER = N'AMENDMENT_NUMBER'

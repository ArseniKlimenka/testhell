...
BEGIN
	...
	INSERT INTO PAS_IMPL.UL_TOOLS_HISTORY
		(TOOL_HISTORY_ID, TOOL_ID, TOOL_NAME, STOCK_TICKER, ISIN, TARIFF_RATE_CURRENCY, STOCK_NAME, MIC, ADDITIONAL_INCOME, TOOL_TYPE, TICKER_BLOOMBERG, NUMBER_CBONDS, COUPON_RATE, REPAYMENT_DATE, OPERATION)
	VALUES
		(NEWID(), @toolId, @toolName, @stockTicker, @isin, @tariffRateCurrency, @stockName, @mic, @additionalIncome, @toolType, @tickerBloomberg, @numberCbonds, @couponRate, @repaymentDate, @operation)
END
...
INSERT INTO PAS_IMPL.UL_TOOLS
    (TOOL_ID, TOOL_NAME, STOCK_TICKER, ISIN, TARIFF_RATE_CURRENCY, STOCK_NAME, MIC, ADDITIONAL_INCOME, TOOL_TYPE, TICKER_BLOOMBERG, NUMBER_CBONDS, COUPON_RATE, REPAYMENT_DATE)
VALUES
    --demo
    (N'0DA66E61-A391-4350-9904-1A1258520EFA', N'Яндекс', N'YNDX', N'NL0009805522', N'RUB', N'MOSCOW EXCHANGE - ALL MARKETS', N'MISX', N'Да', N'Акция', N'YNDX RM EQUITY', NULL, NULL, NULL),
    (N'C64749FC-5F7E-48F0-955B-F2F92D4AA9FF', N'Яндекс2', N'YNDX2', N'NL0009805523', N'RUB', N'MOSCOW EXCHANGE - ALL MARKETS', N'MISX', N'Да', N'Облигация', N'YNDX RM EQUITY2', NULL, NULL, NULL),
    --preEquity
    (N'1A37E566-4F0B-4410-B64C-064F3E284D0D', N'Абрау-Дюрсо, акция об.', N'ABRD', N'RU000A0JS5T7', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'488F05A1-2AAD-4406-ACCE-CAC12CBA1215', N'Авангард АКБ, акция об.', N'AVAN', N'RU000A0DM7B3', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'4A5990B4-FBB7-4B85-8FED-742B463C9CF6', N'АКБ Приморье, акция об.', N'PRMB', N'RU000A0DPNQ5', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'4D9C9CD4-2AD4-41D0-B661-DC30C38F9DAC', N'Акрон, акция об.', N'AKRN', N'RU0009028674', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'57DBCF06-DDCF-4CC4-937C-5A1AAF936799', N'Алкогольная группа Кристалл, акция об.', N'KLVZ', N'RU000A107KX0', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'5C1FFA99-B1D7-4D08-B9C8-4659769F6464', N'АЛРОСА, акция об.', N'ALRS', N'RU0007252813', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'5E9CAD0E-17A7-4667-971C-0C66F445F1FC', N'АПРИ, акция об.', N'APRI', N'RU000A108LJ5', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'6FC1BF73-9544-487D-841C-4204396B5F71', N'Аптечная сеть 36.6, акция об.', N'APTK', N'RU0008081765', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'73210665-A9AA-47AE-898B-089B47BE8EC6', N'Артген Биотех, акция об.', N'ABIO', N'RU000A0JNAB6', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'7CD96AE0-D205-4CB7-AC5C-A81BB3BF6AAA', N'АСКО, акция об.', N'ACKO', N'RU000A0JXS91', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'7DEF5D99-85FB-480D-88CA-FAB8BF3F2ACB', N'Астраханская ЭСК, акция об.', N'ASSB', N'RU000A0D8MM8', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'83AE7DB7-B493-400B-95D6-63E72003CEE6', N'АФК Система, акция об.', N'AFKS', N'RU000A0DQZE3', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'8632C716-664F-4CCC-AF17-710B0C115576', N'Ашинский метзавод, акция об.', N'AMEZ', N'RU000A0B88G6', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'8C8286F0-FBD2-49B7-851C-EA3CB3690CC2', N'Аэрофлот, акция об.', N'AFLT', N'RU0009062285', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'9A83FD8D-5EC4-4436-B729-E5793759B478', N'Банк ВТБ (ПАО), акция об.', N'VTBR', N'RU000A0JP5V6', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'9AB33A39-D946-4386-9835-8903724F535B', N'Банк Кузнецкий, акция об.', N'KUZB', N'RU000A0JSQ66', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL),
    (N'A300DA0A-9FE7-4D63-A608-3A24AFC2D7D7', N'Банк Санкт-Петербург, акция об.', N'BSPB', N'RU0009100945', N'RUB', N'Московская Биржа', N'MISX', NULL, N'Акция', NULL, NULL, NULL, NULL)

		...
		<div class="${properties.kcFormGroupClass!}">
			<div class="${properties.kcInputWrapperClass!} form-group">
				...
				<#if messagesPerField.existsError('${attribute.name}')>
					<span id="input-error-${attribute.name}" class="${properties.kcInputErrorMessageClass!} error-message d-block text-center" aria-live="polite">
...
<#macro inputTag attribute value>
	<input type="<@inputTagType attribute=attribute/>" placeholder="${advancedMsg(attribute.displayName!'')} <#if attribute.required>*</#if>" id="${attribute.name}" name="${attribute.name}" value="${(value!'')}" class="${properties.kcInputClass!} form-control"

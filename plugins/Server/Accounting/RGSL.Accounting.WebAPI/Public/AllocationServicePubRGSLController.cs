...
namespace Adacta.AdInsure.Accounting.WebAPI
{
    ...
    /// </summary>
    [RoutePrefix("api/rgsl/accounting/public/cash-flow/allocation")]
    public class AllocationServicePubRGSLController : AIApiController
    {
        ...
        /// Constructor
        /// </summary>
        public AllocationServicePubRGSLController(IAllocationServiceAppRGSL service) : base() => _service = service;

...
module.exports = function AssetRegisterOfTransaction(input, ambientProperties) {
    ...
    const request = {
        method: 'post',
        url: 'api/core/public/data-exports/ExportAssetTransactionReport/1',
        urlParams: {
            formatterName: 'ExportAssetTransactionExcel'
        },
        data: {
            data: {
                criteria: {

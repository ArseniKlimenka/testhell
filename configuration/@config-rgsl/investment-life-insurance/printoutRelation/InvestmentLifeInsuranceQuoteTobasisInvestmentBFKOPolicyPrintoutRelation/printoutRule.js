...
module.exports = function rule(input) {
    ...
    if (productConf.policyPrintout == 'basisInvestmentBFKOPolicyPrintout' && isEPolicy == false
        && dateHelper.isBefore(dateHelper.formatDate(issueDate), dateHelper.formatDate('2023-02-28'))) {

...
module.exports = function mapping(input) {
    ...
    const isIDG3_5 = [products.IDG3REINVEST, products.IDG5REINVEST, products.IDGV2PPBFKO, products.IDGV3PPBFKO, products.IDGV5PPBFKO, products.IDGP2PB, products.IDGP3PB, products.IDGP5PB].includes(productCode);

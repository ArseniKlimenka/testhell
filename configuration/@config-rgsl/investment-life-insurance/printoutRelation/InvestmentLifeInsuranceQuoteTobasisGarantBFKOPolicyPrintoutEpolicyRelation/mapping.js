...
module.exports = function mapping(input) {
    ...
    const isDriverGarant = [product.IDG3REINVEST, product.IDG5REINVEST, product.IDG3LIFEINVEST, product.IDG5LIFEINVEST, product.IDGP2PB, product.IDGP3PB].includes(productCode);
    ...
    const isTextReinvest = printoutsHelper.unpayedPremiumCondition(issueDate, productCode) || productGroupArray.IDG_ZENIT.includes(productCode);

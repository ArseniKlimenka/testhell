...
module.exports = function mapping(input) {
    ...
    const isU1092 = [products.IBG3BFKO, products.IBG5BFKO, products.EBMGBFKO, products.EBMIBFKO, products.EFRBFKO, products.EBMBFKO, products.WCENOAS, products.EBMPYBFKO, products.EBMPFBFKO, products.IBG5BFKO2].includes(productCode);

const { checkUpSumInsured } = require('@config-rgsl/risk-life-insurance/lib/riskLifeCheckUpSumInsured');
const sumInsuredBasicCalc = require('@config-rgsl/risk-life-insurance/lib/riskLifeSumInsuredBasicCalc');

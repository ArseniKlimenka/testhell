...
const { cleanDeletedRisks } = require('@config-rgsl/life-insurance/lib/lifeInsuranceHelper');
const { cleanCumulationResults } = require('@config-rgsl/life-insurance/lib/cumulationHelper');

module.exports = async function RiskLifeInsuranceQuoteBeforeSave(input, ambientProperties) {

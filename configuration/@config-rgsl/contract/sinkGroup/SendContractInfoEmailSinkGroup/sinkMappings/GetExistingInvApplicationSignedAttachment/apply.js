...
module.exports = function apply(sinkResult, sinkInput, sinkExchange) {
    ...
    if (sinkResult && sinkResult.length > 0) {
        ...
        sinkExchange.mapContext('InvApplicationSignedAttachmentId', lastAttachment.AttachmentId);
        sinkExchange.mapContext('InvApplicationSignedAttachmentFileId', lastAttachment.FileMetadataId);
    }
};

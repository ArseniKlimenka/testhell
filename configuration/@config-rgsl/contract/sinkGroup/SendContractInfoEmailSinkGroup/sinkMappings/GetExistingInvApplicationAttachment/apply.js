...
module.exports = function apply(sinkResult, sinkInput, sinkExchange) {
    ...
    if (sinkResult && sinkResult.length > 0) {
        ...
        sinkExchange.mapContext('InvApplicationAttachmentId', lastAttachment.AttachmentId);
        sinkExchange.mapContext('InvApplicationAttachmentFileId', lastAttachment.FileMetadataId);
    }
};

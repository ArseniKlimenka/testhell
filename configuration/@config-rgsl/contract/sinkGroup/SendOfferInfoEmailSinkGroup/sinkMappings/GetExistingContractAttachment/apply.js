...
module.exports = function apply(sinkResult, sinkInput, sinkExchange) {
    ...
    if (sinkResult && sinkResult.length > 0) {
        ...
        sinkExchange.mapContext('contractAttachmentId', lastAttachment.AttachmentId);
        sinkExchange.mapContext('contractAttachmentFileId', lastAttachment.FileMetadataId);
    }
};

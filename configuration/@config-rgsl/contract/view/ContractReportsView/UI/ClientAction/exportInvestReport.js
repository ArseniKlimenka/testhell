module.exports = function exportInvestReport(input, ambientProperties) {

    const request = {
        method: 'post',
        url: 'api/core/public/data-exports/ExportInvestReport/1',
        urlParams: {
            formatterName: 'ExportInvestReportExcel'
        },
        data: {},

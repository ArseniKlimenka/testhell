'use strict';
const { paymentOrderStates, paymentOrderType, paymentOrderSubType } = require('@config-rgsl/acc-base/lib/paymentOrderConst');
...
module.exports = function rule(input) {
    ...
    const isEndowment = input.body.paymentOrderInformation.paymentOrderType === paymentOrderType.Claim &&
    input.body.paymentOrderInformation.paymentOrderSubType === paymentOrderSubType.Endowment;
    ...
    if (isEndowment && currentState !== paymentOrderStates.Cancelled && currentActor !== 'PaymentOrderViewer') {

const { medCheckUpSumInsured } = require('@config-rgsl/med-life-insurance/lib/medCheckUpSumInsured');
const sumInsuredBasicCalc = require('@config-rgsl/med-life-insurance/lib/medSumInsuredBasicCalc');
...
module.exports = {
    ...
    CU10800: function (riskData, input, risk) {
        ...
        return {
            sumInsured: medCheckUpSumInsured({ productCode, paymentFrequency, installmentAmount }).sumInsured || 0
        };
    },

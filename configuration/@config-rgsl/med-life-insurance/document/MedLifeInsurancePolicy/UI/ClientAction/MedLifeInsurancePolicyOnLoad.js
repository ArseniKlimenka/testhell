...
module.exports = async function MedLifeInsurancePolicyOnLoad(input, ambientProperties) {
    ...
    await createMedLifeInsuranceQuoteFromMed(input, ambientProperties, this);

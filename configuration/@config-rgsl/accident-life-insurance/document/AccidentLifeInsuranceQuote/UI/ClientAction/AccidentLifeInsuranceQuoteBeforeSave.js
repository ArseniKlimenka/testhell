...
module.exports = async function AccidentLifeInsuranceQuoteBeforeSave(input, ambientProperties) {
...
async function evaluatePolicy(input, ambientProperties, self) {
    ...
    try {
        ...
        await self.view.evaluate([
            '/technicalInformation[CheckContractDuplicates]'
        ], false, true);

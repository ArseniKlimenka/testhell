...
module.exports = async function arrayOperationHandler(input) {
    ...
    const callingEntityView = commentsContainerView.getParentView();
    ...
    if (operationType == 'Add') {
        ...
        const res = await callingEntityView.commentManager.editComment(affectedRow.id, affectedRow.comment);

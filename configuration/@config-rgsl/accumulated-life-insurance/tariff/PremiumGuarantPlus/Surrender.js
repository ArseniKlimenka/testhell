...
const surrenderValuesCoefficients = require('./rules/premiumGuarantPlusSurrenderValues');
...
module.exports = function surrender(input) {
    ...
    return accumulatedSurrenderValuesCalc.surrenderValuesCalculationByPremium(input, surrenderCoefficients);
};

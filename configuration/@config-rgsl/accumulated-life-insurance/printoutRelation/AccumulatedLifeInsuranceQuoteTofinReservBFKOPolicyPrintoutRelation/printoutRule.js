...
module.exports = function rule(input) {
    ...
    const calcFromInsuredSum = body.basicConditions?.calcFromInsuredSum ?? false;
    ...
    if (!productCode || !issueDate || !insuranceTerm || !paymentFrequencyCode || (!calcFromInsuredSum && calcFromInsuredSum) ||
        (!riskPremium && !calcFromInsuredSum) || !phDateOfBirth || !phPersonGender || !ipDateOfBirth || !ipPersonGender) {
    ...
    if (productConf.policyPrintout == 'finReservBFKOPolicyPrintout' && isEPolicy == false) {

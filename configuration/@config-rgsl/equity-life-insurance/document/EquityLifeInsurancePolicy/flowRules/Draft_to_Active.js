...
module.exports = function rule(input) {
    ...
    if (!isSkipAttachmentsValidationAPI) {
        ...
        if (!isEPolicy && !isPolicyHolder && !attachmentsPackage.some(item => item.entityId.toUpperCase() == insuredPersonPartyId.toUpperCase() && item.attachmentType == 'passport')) {
            validationErrors.push({
                errorCode: "Draft_to_Active_insuredPersonAttachment_passport"
            });
        }

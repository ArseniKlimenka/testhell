...
module.exports = function (input) {
    ...
    if (agentPartyType) {
        ...
        if (agentPartyType == partyType.soleProprietor) {
            searchRequest.query.bool.must.push({
                match: {
                    'body.isPersonalBusiness': true
                }
            });
        } else {
            searchRequest.query.bool.must.push(
    ...
    if (agency) {
        ...
        searchRequest.query.bool.must.push({
            ...
            match: {
                'body.attributes.mainAttributes.agency.code': agency.code
            }
        });
    }
    ...
    if (cbAgentType) {
        ...
        searchRequest.query.bool.must.push({
            ...
            match: {
                'body.attributes.mainAttributes.cbAgentType.code': cbAgentType.code
            }
        });
    }

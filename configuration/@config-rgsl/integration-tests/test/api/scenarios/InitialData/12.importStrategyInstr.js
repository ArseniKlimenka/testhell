...
async function importStrategyInstr(step, context, stepContext) {
    ...
    const body = {
        file: {
            fileId: undefined,
            fileName: 'strategyInstruments.xlsx',
        },
        summary: {},
        sourceFileFormat: 1,
    };

    const builder = new VersionedDocumentBuilderRgsl('StrategyInstrImport');

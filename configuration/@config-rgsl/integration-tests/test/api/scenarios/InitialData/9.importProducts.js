...
async function importProducts(step, context, stepContext) {
    ...
    const body = {
        file: {
            fileId: undefined,
            fileName: 'productConfiguration.xlsx',
        },
        summary: {},
        sourceFileFormat: 1,
    };

    const builder = new VersionedDocumentBuilderRgsl('ProductConfigurationImport');

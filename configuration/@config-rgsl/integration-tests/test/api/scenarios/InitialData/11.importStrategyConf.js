...
async function importStrategyConf(step, context, stepContext) {
    ...
    const body = {
        file: {
            fileId: undefined,
            fileName: 'strategyConfiguration.xlsx',
        },
        summary: {},
        sourceFileFormat: 1,
    };

    const builder = new VersionedDocumentBuilderRgsl('StrategyConfImport');

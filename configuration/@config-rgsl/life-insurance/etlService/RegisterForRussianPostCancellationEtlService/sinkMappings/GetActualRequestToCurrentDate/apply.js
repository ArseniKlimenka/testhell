...
module.exports = function apply(sinkResult, sinkInput, sinkExchange) {
    ...
    sinkExchange.workingDaysBeforeCurrentDate = workingDays.filter(workingDays => workingDays.date < sinkExchange.currentDate).length; // Рабочие дни с даты создания Запроса до текущей даты.

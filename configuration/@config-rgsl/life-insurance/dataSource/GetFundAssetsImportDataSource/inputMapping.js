...
module.exports = function (input) {
    ...
    output.parameters.isRelatedToFundReportDate = null;
    ...
    if (criteria.isRelatedToFundReportDate) {
        output.parameters.isRelatedToFundReportDate = criteria.isRelatedToFundReportDate;
    }

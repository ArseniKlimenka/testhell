...
module.exports = function resultMapping(input) {
    ...
    output.productDescriptionConf = input.PRODUCT_DESCRIPTION;
    ...
    output.activeFrom = DateTimeUtils.formatDate(input.ACTIVE_FROM, DateTimeUtils.DateFormats.ECMASCRIPT);
    output.activeTo = DateTimeUtils.formatDate(input.ACTIVE_TO, DateTimeUtils.DateFormats.ECMASCRIPT);

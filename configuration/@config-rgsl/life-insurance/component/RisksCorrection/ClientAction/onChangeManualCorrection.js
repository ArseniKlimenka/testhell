...
module.exports = async function onChangeManualCorrection(input, ambientProperties) {
    ...
    const correctionWithoutCalc = input.data.correctionWithoutCalc;
    ...
    if (manualCorrection && (manualRiskDeletion || replaceDisabilityAnyReason || correctionWithoutCalc) && isVTB) {
        ...
        input.data.manualCorrection = false;
    }
};

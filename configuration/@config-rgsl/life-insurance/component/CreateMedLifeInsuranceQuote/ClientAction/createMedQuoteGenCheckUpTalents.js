...
module.exports = function createMedQuoteGenCheckUpTalents(input, ambientProperties) {

    const createMedQuoteFromButton = true;
    const isTalentsDMSButton = true;
    ...
    if (isAccumulatedLifeInsurancePolicy) {
        createMedLifeInsuranceQuoteFromAccumulated(input, ambientProperties, this, createMedQuoteFromButton, isTalentsDMSButton);
    }

...
module.exports = function mapping(input, sinkExchange, additionalDataSourcesResults) {
    ...
    return createLifeAmendmentCancellationMapping(input, sinkExchange, additionalDataSourcesResults, lifeInsuranceConstants.productCode.InvestmentLifeInsurancePolicy);
};

...
module.exports = function mapping(input, sinkExchange, additionalDataSourcesResults) {
    ...
    return updateLifeAmendmentCancellationMapping(input, sinkExchange, additionalDataSourcesResults, lifeInsuranceConstants.productCode.AccidentLifeInsurancePolicy);

...
module.exports = async function exportFilteredStrategyInstr(input, ambientProperties) {
    ...
    const request = {
        method: 'post',
        url: 'api/core/public/data-exports/ExportStrategyInstr/1',
        urlParams: {
            formatterName: 'ExportExcelStrategyInstr'
        },
        data: exportRequest,
    ...
    ambientProperties.services.api.call(request)
        .then(async (result) => {
            ...
            downloadLink.download = decodeURIComponent(`strategyInstruments`);

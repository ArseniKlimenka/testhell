...
module.exports = async function exportFilteredRateOfReturnRules(input, ambientProperties) {
    ...
    const request = {
        method: 'post',
        url: 'api/core/public/data-exports/ExportRateOfReturnRules/1',
        urlParams: {
            formatterName: 'ExportExcelRateOfReturnRules'
        },
        data: exportRequest,
    ...
    ambientProperties.services.api.call(request)
        .then(async (result) => {
            ...
            downloadLink.download = decodeURIComponent(`rateOfReturnRules`);

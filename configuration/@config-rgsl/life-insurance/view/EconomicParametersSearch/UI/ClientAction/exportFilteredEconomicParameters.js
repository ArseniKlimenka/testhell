...
module.exports = async function exportFilteredEconomicParameters(input, ambientProperties) {
    ...
    const request = {
        method: 'post',
        url: 'api/core/public/data-exports/ExportEconomicParameters/1',
        urlParams: {
            formatterName: 'ExportExcelEconomicParameters'
        },
        data: exportRequest,
    ...
    ambientProperties.services.api.call(request)
        .then(async (result) => {
            ...
            downloadLink.download = decodeURIComponent(`economicParameters`);
